...
struct ABP_Metal_Crate_Small_C : ABP_DeployableContainerBase_C {
	...
	void ExecuteUbergraph_BP_Metal_Crate_Small(int32_t EntryPoint); // Function BP_Metal_Crate_Small.BP_Metal_Crate_Small_C.ExecuteUbergraph_BP_Metal_Crate_Small // (Final|UbergraphFunction) // @ game+0x1a04fd0
};
