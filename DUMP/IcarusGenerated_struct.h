...
enum class EMetaInventoryID : uint8 {
	MetaInventoryID_UndefinedID,
	MetaInventoryID_Main,
	MetaInventoryID_DropLoadout,
	MetaInventoryID_MAX,
};
...
enum class EDropshipType : uint8 {
	DropshipType_UndefinedID,
	DropshipType_Player,
	DropshipType_Equipment,
	DropshipType_MAX,
};
...
enum class ENotificationType : uint8 {
	...
	MissionSummary,
	ItemRecovery,
	MaxNotificationTypes,
	ENotificationType_MAX,
};

// Enum IcarusGenerated.EUpdateProspectFailure
enum class EUpdateProspectFailure : uint8 {
	UpdateProspectFailure_UndefinedID,
	UpdateProspectFailure_NotHost,
	UpdateProspectFailure_Expired,
	UpdateProspectFailure_NotNewer,
	UpdateProspectFailure_Other,
	UpdateProspectFailure_MAX,
};
