...
struct UCRE_PolarBear_Hero_AnimBP_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function CRE_PolarBear_Hero_AnimBP.CRE_PolarBear_Hero_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	float GetIKStrength(); // Function CRE_PolarBear_Hero_AnimBP.CRE_PolarBear_Hero_AnimBP_C.GetIKStrength // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1a04fd0
	void CalcRotationRate(float CurrentYaw, float YawRotationRate); // Function CRE_PolarBear_Hero_AnimBP.CRE_PolarBear_Hero_AnimBP_C.CalcRotationRate // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function CRE_PolarBear_Hero_AnimBP.CRE_PolarBear_Hero_AnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1a04fd0
	void BlueprintBeginPlay(); // Function CRE_PolarBear_Hero_AnimBP.CRE_PolarBear_Hero_AnimBP_C.BlueprintBeginPlay // (Event|Public|BlueprintEvent) // @ game+0x1a04fd0
	void SetIKEnabled(bool Value); // Function CRE_PolarBear_Hero_AnimBP.CRE_PolarBear_Hero_AnimBP_C.SetIKEnabled // (BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void ExecuteUbergraph_CRE_PolarBear_Hero_AnimBP(int32_t EntryPoint); // Function CRE_PolarBear_Hero_AnimBP.CRE_PolarBear_Hero_AnimBP_C.ExecuteUbergraph_CRE_PolarBear_Hero_AnimBP // (Final|UbergraphFunction) // @ game+0x1a04fd0
};
