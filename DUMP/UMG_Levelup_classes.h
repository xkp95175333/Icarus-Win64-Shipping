...
struct UUMG_Levelup_C : UUserWidget {
	...
	bool UnlockCheck(int32_t Level, struct FItemableRowHandle Itemable); // Function UMG_Levelup.UMG_Levelup_C.UnlockCheck // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void Construct(); // Function UMG_Levelup.UMG_Levelup_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1a04fd0
	void OnExperienceUpdated(); // Function UMG_Levelup.UMG_Levelup_C.OnExperienceUpdated // (BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void ExecuteUbergraph_UMG_Levelup(int32_t EntryPoint); // Function UMG_Levelup.UMG_Levelup_C.ExecuteUbergraph_UMG_Levelup // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a04fd0
};
