...
struct USK-Bear_AnimBP_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function SK-Bear_AnimBP.SK-Bear_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	float GetIKStrength(); // Function SK-Bear_AnimBP.SK-Bear_AnimBP_C.GetIKStrength // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1a04fd0
	void CalcRotationRate(float CurrentYaw, float YawRotationRate); // Function SK-Bear_AnimBP.SK-Bear_AnimBP_C.CalcRotationRate // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void EvaluateGraphExposedInputs_ExecuteUbergraph_SK-Bear_AnimBP_AnimGraphNode_BlendListByBool_08BC8BF4457ACC9ECCC6138F7452FA27(); // Function SK-Bear_AnimBP.SK-Bear_AnimBP_C.EvaluateGraphExposedInputs_ExecuteUbergraph_SK-Bear_AnimBP_AnimGraphNode_BlendListByBool_08BC8BF4457ACC9ECCC6138F7452FA27 // (BlueprintEvent) // @ game+0x1a04fd0
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function SK-Bear_AnimBP.SK-Bear_AnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1a04fd0
	void BlueprintBeginPlay(); // Function SK-Bear_AnimBP.SK-Bear_AnimBP_C.BlueprintBeginPlay // (Event|Public|BlueprintEvent) // @ game+0x1a04fd0
	void SetIKEnabled(bool Value); // Function SK-Bear_AnimBP.SK-Bear_AnimBP_C.SetIKEnabled // (BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void ExecuteUbergraph_SK-Bear_AnimBP(int32_t EntryPoint); // Function SK-Bear_AnimBP.SK-Bear_AnimBP_C.ExecuteUbergraph_SK-Bear_AnimBP // (Final|UbergraphFunction) // @ game+0x1a04fd0
};
