...
struct UUMG_ItemPopup_C : UUserWidget {
	...
	void UpdateMetaVisuals(); // Function UMG_ItemPopup.UMG_ItemPopup_C.UpdateMetaVisuals // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void GetSize(struct FVector2D Size); // Function UMG_ItemPopup.UMG_ItemPopup_C.GetSize // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void Show for Item(struct FItemData Item, bool Shown); // Function UMG_ItemPopup.UMG_ItemPopup_C.Show for Item // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
};
