...
struct ABP_Light_Spotlight_C : ABP_DeployableBase_C {
	...
	void OnRep_LightActive(); // Function BP_Light_Spotlight.BP_Light_Spotlight_C.OnRep_LightActive // (BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void Deployable_Interact(struct AActor* Interactor); // Function BP_Light_Spotlight.BP_Light_Spotlight_C.Deployable_Interact // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
};
