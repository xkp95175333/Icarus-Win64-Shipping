...
struct ABP_Battery_C : ABP_DeployableBase_C {
	...
	void ReceiveTick(float DeltaSeconds); // Function BP_Battery.BP_Battery_C.ReceiveTick // (Event|Public|BlueprintEvent) // @ game+0x1a04fd0
	void ExecuteUbergraph_BP_Battery(int32_t EntryPoint); // Function BP_Battery.BP_Battery_C.ExecuteUbergraph_BP_Battery // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a04fd0
};
