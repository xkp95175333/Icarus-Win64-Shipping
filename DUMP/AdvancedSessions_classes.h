...
struct UAdvancedFriendsGameInstance : UGameInstance {
	...
	void OnSessionInviteReceived(int32_t LocalPlayerNum, struct FBPUniqueNetId PersonInviting, struct FString AppId, struct FBlueprintSessionResult SessionToJoin); // Function AdvancedSessions.AdvancedFriendsGameInstance.OnSessionInviteReceived // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0x1a04fd0
	void OnSessionInviteAccepted(int32_t LocalPlayerNum, struct FBPUniqueNetId PersonInvited, struct FBlueprintSessionResult SessionToJoin); // Function AdvancedSessions.AdvancedFriendsGameInstance.OnSessionInviteAccepted // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0x1a04fd0
	void OnPlayerTalkingStateChanged(struct FBPUniqueNetId PlayerID, bool bIsTalking); // Function AdvancedSessions.AdvancedFriendsGameInstance.OnPlayerTalkingStateChanged // (Event|Public|BlueprintEvent) // @ game+0x1a04fd0
	void OnPlayerLoginStatusChanged(int32_t PlayerNum, enum class EBPLoginStatus PreviousStatus, enum class EBPLoginStatus NewStatus, struct FBPUniqueNetId NewPlayerUniqueNetID); // Function AdvancedSessions.AdvancedFriendsGameInstance.OnPlayerLoginStatusChanged // (Event|Public|BlueprintEvent) // @ game+0x1a04fd0
	void OnPlayerLoginChanged(int32_t PlayerNum); // Function AdvancedSessions.AdvancedFriendsGameInstance.OnPlayerLoginChanged // (Event|Public|BlueprintEvent) // @ game+0x1a04fd0
};
...
struct UAdvancedFriendsInterface : UInterface {
	...
	void OnSessionInviteReceived(struct FBPUniqueNetId PersonInviting, struct FBlueprintSessionResult SearchResult); // Function AdvancedSessions.AdvancedFriendsInterface.OnSessionInviteReceived // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0x1a04fd0
	void OnSessionInviteAccepted(struct FBPUniqueNetId PersonInvited, struct FBlueprintSessionResult SearchResult); // Function AdvancedSessions.AdvancedFriendsInterface.OnSessionInviteAccepted // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0x1a04fd0
	void OnPlayerVoiceStateChanged(struct FBPUniqueNetId PlayerID, bool bIsTalking); // Function AdvancedSessions.AdvancedFriendsInterface.OnPlayerVoiceStateChanged // (Event|Public|BlueprintEvent) // @ game+0x1a04fd0
	void OnPlayerLoginStatusChanged(enum class EBPLoginStatus PreviousStatus, enum class EBPLoginStatus NewStatus, struct FBPUniqueNetId PlayerUniqueNetID); // Function AdvancedSessions.AdvancedFriendsInterface.OnPlayerLoginStatusChanged // (Event|Public|BlueprintEvent) // @ game+0x1a04fd0
	void OnPlayerLoginChanged(int32_t PlayerNum); // Function AdvancedSessions.AdvancedFriendsInterface.OnPlayerLoginChanged // (Event|Public|BlueprintEvent) // @ game+0x1a04fd0
};
