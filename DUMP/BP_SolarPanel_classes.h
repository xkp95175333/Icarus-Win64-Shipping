...
struct ABP_SolarPanel_C : ABP_DeployableBase_C {
	...
	void UpdateText(); // Function BP_SolarPanel.BP_SolarPanel_C.UpdateText // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void UpdateActivity(); // Function BP_SolarPanel.BP_SolarPanel_C.UpdateActivity // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	bool Trace(struct FVector Start, struct FVector End); // Function BP_SolarPanel.BP_SolarPanel_C.Trace // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void GetTime(); // Function BP_SolarPanel.BP_SolarPanel_C.GetTime // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void Init(); // Function BP_SolarPanel.BP_SolarPanel_C.Init // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void ReceiveBeginPlay(); // Function BP_SolarPanel.BP_SolarPanel_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0x1a04fd0
	void CheckForObstruction(); // Function BP_SolarPanel.BP_SolarPanel_C.CheckForObstruction // (BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void ReceiveTick(float DeltaSeconds); // Function BP_SolarPanel.BP_SolarPanel_C.ReceiveTick // (Event|Public|BlueprintEvent) // @ game+0x1a04fd0
	void ExecuteUbergraph_BP_SolarPanel(int32_t EntryPoint); // Function BP_SolarPanel.BP_SolarPanel_C.ExecuteUbergraph_BP_SolarPanel // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a04fd0
};
