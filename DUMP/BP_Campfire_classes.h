...
struct ABP_Campfire_C : ABP_ProcessorBase_C {
	...
	void OnRep_ActiveEffects(); // Function BP_Campfire.BP_Campfire_C.OnRep_ActiveEffects // (HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void UserConstructionScript(); // Function BP_Campfire.BP_Campfire_C.UserConstructionScript // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void ReceiveBeginPlay(); // Function BP_Campfire.BP_Campfire_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0x1a04fd0
	...
	void DeactivateCampfire(); // Function BP_Campfire.BP_Campfire_C.DeactivateCampfire // (BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void OnGeneratorActiveStateUpdated(bool IsActive); // Function BP_Campfire.BP_Campfire_C.OnGeneratorActiveStateUpdated // (BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void ExecuteUbergraph_BP_Campfire(int32_t EntryPoint); // Function BP_Campfire.BP_Campfire_C.ExecuteUbergraph_BP_Campfire // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a04fd0
};
