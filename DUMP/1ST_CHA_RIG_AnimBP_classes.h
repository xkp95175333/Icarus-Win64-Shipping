...
struct U1ST_CHA_RIG_AnimBP_C : UIcarusCharacterAnimInstance {
	...
	struct TSoftObjectPtr<struct UBlendSpaceBase> LocomotionBS; // 0x3d40(0x28)
	...
	void VehicleLowerBody(struct FPoseLink LowerInPose, struct FPoseLink VehicleLowerBody); // Function 1ST_CHA_RIG_AnimBP.1ST_CHA_RIG_AnimBP_C.VehicleLowerBody // (HasOutParms|BlueprintCallable) // @ game+0x1a04fd0
	void VehicleUpperBody(struct FPoseLink UpperInPose, struct FPoseLink VehicleUpperBody); // Function 1ST_CHA_RIG_AnimBP.1ST_CHA_RIG_AnimBP_C.VehicleUpperBody // (HasOutParms|BlueprintCallable) // @ game+0x1a04fd0
	void AnimGraph(struct FPoseLink AnimGraph); // Function 1ST_CHA_RIG_AnimBP.1ST_CHA_RIG_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	bool IsSwimming(); // Function 1ST_CHA_RIG_AnimBP.1ST_CHA_RIG_AnimBP_C.IsSwimming // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1a04fd0
	bool IsCurrentlyJumping(); // Function 1ST_CHA_RIG_AnimBP.1ST_CHA_RIG_AnimBP_C.IsCurrentlyJumping // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1a04fd0
	void UpdateADS(); // Function 1ST_CHA_RIG_AnimBP.1ST_CHA_RIG_AnimBP_C.UpdateADS // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	struct UBlendSpaceBase* GetCurrentLocoBlendspace(); // Function 1ST_CHA_RIG_AnimBP.1ST_CHA_RIG_AnimBP_C.GetCurrentLocoBlendspace // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1a04fd0
	...
	void OnLoaded_2B8B2B624CE5F97DAE6892B735D7183E(struct UObject* Loaded); // Function 1ST_CHA_RIG_AnimBP.1ST_CHA_RIG_AnimBP_C.OnLoaded_2B8B2B624CE5F97DAE6892B735D7183E // (BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void OnLoaded_2B8B2B624CE5F97DAE6892B70A336DF9(struct UObject* Loaded); // Function 1ST_CHA_RIG_AnimBP.1ST_CHA_RIG_AnimBP_C.OnLoaded_2B8B2B624CE5F97DAE6892B70A336DF9 // (BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function 1ST_CHA_RIG_AnimBP.1ST_CHA_RIG_AnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1a04fd0
	void BlueprintBeginPlay(); // Function 1ST_CHA_RIG_AnimBP.1ST_CHA_RIG_AnimBP_C.BlueprintBeginPlay // (Event|Public|BlueprintEvent) // @ game+0x1a04fd0
	void WeaponFired(float Power); // Function 1ST_CHA_RIG_AnimBP.1ST_CHA_RIG_AnimBP_C.WeaponFired // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void OnFocusedItemUpdated(struct AIcarusItem* Item); // Function 1ST_CHA_RIG_AnimBP.1ST_CHA_RIG_AnimBP_C.OnFocusedItemUpdated // (Event|Public|BlueprintEvent) // @ game+0x1a04fd0
	void ExecuteUbergraph_1ST_CHA_RIG_AnimBP(int32_t EntryPoint); // Function 1ST_CHA_RIG_AnimBP.1ST_CHA_RIG_AnimBP_C.ExecuteUbergraph_1ST_CHA_RIG_AnimBP // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a04fd0
};
