...
struct ABP_ElectricFurnace_C : ABP_ProcessorBase_C {
	...
	void OnRep_ActiveEffects(); // Function BP_ElectricFurnace.BP_ElectricFurnace_C.OnRep_ActiveEffects // (HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void ReceiveBeginPlay(); // Function BP_ElectricFurnace.BP_ElectricFurnace_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0x1a04fd0
	void OnGeneratorComponentStateChanged(bool IsActive); // Function BP_ElectricFurnace.BP_ElectricFurnace_C.OnGeneratorComponentStateChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1a04fd0
	void ExecuteUbergraph_BP_ElectricFurnace(int32_t EntryPoint); // Function BP_ElectricFurnace.BP_ElectricFurnace_C.ExecuteUbergraph_BP_ElectricFurnace // (Final|UbergraphFunction) // @ game+0x1a04fd0
};
