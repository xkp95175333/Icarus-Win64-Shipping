...
struct UVirtualHeightfieldMeshComponent : UPrimitiveComponent {
	struct TSoftObjectPtr<struct ARuntimeVirtualTextureVolume> VirtualTexture; // 0x440(0x28)
	...
	void GatherHideFlags(bool InOutHidePrimitivesInEditor, bool InOutHidePrimitivesInGame); // Function VirtualHeightfieldMesh.VirtualHeightfieldMeshComponent.GatherHideFlags // (Final|Native|Protected|HasOutParms|Const) // @ game+0xae46c0
};
